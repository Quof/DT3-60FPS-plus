/*
**  Usage:
**      draw_sprite_wave_fixed(sprite,subimage,x,y,axis,wavelength,amplitude,phase)
**
**  Arguments:
**      sprite          sprite index
...
for (i=0; i<size; i+=1) {
  ...
  if (axis) {
    sx = shift-xoff+posx;
    sy = i-yoff+posy;
    draw_sprite_part_ext(sprite,image,0,i,width,1,sx,sy,1,1,image_blend,image_alpha);
  }else{
    sx = i-xoff+posx;
    sy = shift-yoff+posy;
    draw_sprite_part_ext(sprite,image,i,0,1,height,sx,sy,1,1,image_blend,image_alpha);
  }
}
