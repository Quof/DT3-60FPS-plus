...
It will create a text box from the associated character.
*/
with oMessageNPCchat
  instance_destroy()
...
tNewMessage=instance_create(x-tBoxOffsetX,y-16-sprite_height-tBoxOffsetY,oMessageNPCchat)
