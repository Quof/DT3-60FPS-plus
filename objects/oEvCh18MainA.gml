...
else if global.gameProgress=4420 and room=rLowFacJ //----- [] Enemy Trap: Spider Drone -----
{
  ...
  else if sceneProgress=1
  {
    ...
    {
      with (GID(378907)) {instance_destroy()}
      sceneDelay=0; sceneProgress+=1
    }
  }
  else if sceneProgress=2
...
else if global.gameProgress=4470 and room=rLowFacS //----- [] Hex and the Warship -----
{
  ...
  if global.gamePaused=false
  {
    ...
    else if sceneProgress=13
    {
      ...
      //Destroy platform
      if sceneDelay=90 {firePillarX=624}; else if sceneDelay=154 {playSound(global.snd_Bobomb,0,1,1); with (GID(383064)) {instance_destroy()}}
      else if sceneDelay=180 {firePillarX=752}; else if sceneDelay=244 {playSound(global.snd_Bobomb,0,1,1); with (GID(383068)) {instance_destroy()}}
      else if sceneDelay=280 {firePillarX=656}; else if sceneDelay=344 {playSound(global.snd_Bobomb,0,1,1); with (GID(383065)) {instance_destroy()}}
      else if sceneDelay=370 {firePillarX=560}; else if sceneDelay=434 {playSound(global.snd_Bobomb,0,1,1); with (GID(383062)) {instance_destroy()}}
      else if sceneDelay=440 {firePillarX=784}; else if sceneDelay=514 {playSound(global.snd_Bobomb,0,1,1); with (GID(383069)) {instance_destroy()}}
      else if sceneDelay=520 {firePillarX=592}; else if sceneDelay=584 {playSound(global.snd_Bobomb,0,1,1); with (GID(383063)) {instance_destroy()}}
      else if sceneDelay=580 {firePillarX=720}; else if sceneDelay=644 {playSound(global.snd_Bobomb,0,1,1); with (GID(383067)) {instance_destroy()}}
      else if sceneDelay=660 {firePillarX=688}; else if sceneDelay=724 {playSound(global.snd_Bobomb,0,1,1); with (GID(383066)) {instance_destroy()}}
    }
