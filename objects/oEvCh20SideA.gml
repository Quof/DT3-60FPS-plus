...
if global.gamePaused=false
{
  if room=rWarshipB
  {
    if global.gameProgress=5060 //Jerry asks Claire about their relationship
    {
      ...
      else if charDialogue[0]=5 {convo[0]+=1*gDeltaTime;if convo[0]>=160 {charDialogue[0]+=1; convo[0]=0}}
      else if charDialogue[0]=6
      {
        msgCreate(0,0,"Claire","You're right about that.",0,1,oMessagePerson,0)
        newMessage.fadingTime=60; charDialogue[0]+=1
      }
      else if charDialogue[0]=7 {convo[0]+=1*gDeltaTime;if convo[0]>=60 {charDialogue[0]+=1; convo[0]=0}}
      ...
      else if charDialogue[0]=9 {convo[0]+=1*gDeltaTime;if convo[0]>=150 {charDialogue[0]+=1; convo[0]=0}}
      else if charDialogue[0]=10
      {
        msgCreate(0,0,"Claire","...",0,1,oMessagePerson,0)
        newMessage.fadingTime=40; charDialogue[0]+=1
      }
      else if charDialogue[0]=11 {convo[0]+=1*gDeltaTime;if convo[0]>=40 {charDialogue[0]+=1; convo[0]=0}}
      ...
      else if charDialogue[0]=13 {convo[0]+=1*gDeltaTime;if convo[0]>=140 {charDialogue[0]+=1; convo[0]=0}}
      ...
      else if charDialogue[0]=17 {convo[0]+=1*gDeltaTime;if convo[0]>=70 {charDialogue[0]+=1; convo[0]=0}}
      else if charDialogue[0]=18
      {
        msgCreate(0,0,"Claire","Let's get this done first.",0,1,oMessagePerson,0)
        newMessage.fadingTime=60; charDialogue[0]+=1
      }
      else if charDialogue[0]=19 {convo[0]+=1*gDeltaTime;if convo[0]>=60 {charDialogue[0]+=1; convo[0]=0}}
      else if charDialogue[0]=20
      {
        msgCreate(0,0,"Jerry","Right on.",0,1,oMessagePerson,0)
        newMessage.fadingTime=50; charDialogue[0]+=1
      }
      else if charDialogue[0]=21 {convo[0]+=1*gDeltaTime;if convo[0]>=50 {charDialogue[0]+=1; convo[0]=0}}
    }
  }
  else if room=rWarshipZ_F
  {
    if global.gameProgress=5320 //Jeremy informs that this part isn't very long and Chao has a question
    {
      ...
      else if charDialogue[0]=3 {convo[0]+=1*gDeltaTime;if convo[0]>=190 {charDialogue[0]+=1; convo[0]=0}}
      else if charDialogue[0]=4
      {
  ...
  else if room=rWarshipZ_I
  {
    if global.gameProgress>=5500 //Jeremy blocks the path, not getting that ending again
    {
      ...
      else if charDialogue[0]=3 {convo[0]+=1*gDeltaTime;if convo[0]>=170 {charDialogue[0]+=1; convo[0]=0}}
      else if charDialogue[0]=4
      {
