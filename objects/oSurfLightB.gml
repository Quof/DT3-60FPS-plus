...
applies_to=self
*/
//Lights: Player, Chao(Small light), Enemies
...
if surface_exists(surf)
{
  ...
  if oIdentifier.bChaoActive=1 {draw_sprite_ext(sSurfOmniLightA,0,oIdentifier.x,oIdentifier.y,0.6+sizeMod,0.6+sizeMod,0,c_white,1)}
  with oEnemyBase
  {
    draw_sprite_ext(sSurfOmniLightA,0,x+8,y+8,1+oSurfLightB.sizeMod,1+oSurfLightB.sizeMod,0,c_white,0.65)
  }
