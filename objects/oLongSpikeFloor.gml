...
applies_to=self
*/
draw_sprite_ext(sLongSpikeMid,-1,x+15,ySPlace+8,1,-extendDist,180,c_white,1)
draw_sprite_ext(sLongSpikeEnd,-1,x+15,y+8+extendDist,1,1,180,c_white,1)
