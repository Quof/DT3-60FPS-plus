...
applies_to=self
*/
eName=string("Lv.") +string(siegeLv) +string(" CHAOS Siege Crab Tank")

maxLife=1400+((siegeLv-1)*700)
life=maxLife
runAcc=1.9+((siegeLv-1)*0.05)
#define Step_0
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=603
...
if global.gamePaused=false
{
  ...
  else if life<=0
  {
    ...
    oTD_HUD.tdStat_Resources+=5+(18*siegeLv)
    instance_destroy()
  }
  enemyStepEvent()
}
