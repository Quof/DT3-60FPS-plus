...
if global.gamePaused=false
{
  if room=rVault_1
  {
    if global.gameProgress=2170 //Having dreams - Claire
    {
      ...
      else if charDialogue[0]=1 {convo[0]+=1*gDeltaTime;if convo[0]>=95 {charDialogue[0]+=1; convo[0]=0}}
      ...
      else if charDialogue[0]=5 {convo[0]+=1*gDeltaTime;if convo[0]>=105 {charDialogue[0]+=1; convo[0]=0}}
      ...
      else if charDialogue[0]=7 {convo[0]+=1*gDeltaTime;if convo[0]>=85 {charDialogue[0]+=1; convo[0]=0}}
      ...
      else if charDialogue[0]=9 {convo[0]+=1*gDeltaTime;if convo[0]>=125 {charDialogue[0]+=1; convo[0]=0}}
      ...
      else if charDialogue[0]=11 {convo[0]+=1*gDeltaTime;if convo[0]>=80 {charDialogue[0]+=1; convo[0]=0}}
      ...
      else if charDialogue[0]=17 {convo[0]+=1*gDeltaTime;if convo[0]>=135 {charDialogue[0]+=1; convo[0]=0}}
    ...
    else if global.gameProgress=2250 //Having dreams - Jerry
    {
      ...
      else if charDialogue[0]=3 {convo[0]+=1*gDeltaTime;if convo[0]>=85 {charDialogue[0]+=1; convo[0]=0}}
      else if charDialogue[0]=4
      {
      ...
      else if charDialogue[0]=7 {convo[0]+=1*gDeltaTime;if convo[0]>=50 {charDialogue[0]+=1; convo[0]=0}}
      else if charDialogue[0]=8
      {
      ...
      else if charDialogue[0]=9 {convo[0]+=1*gDeltaTime;if convo[0]>=135 {charDialogue[0]+=1; convo[0]=0}}
      else if charDialogue[0]=10
      {
      ...
      else if charDialogue[0]=11 {convo[0]+=1*gDeltaTime;if convo[0]>=130 {charDialogue[0]+=1; convo[0]=0}}
      else if charDialogue[0]=12
      {
  ...
  else if global.gameProgress=2190 and room=rVault_2 //Sticks for platforms
  {
    ...
    else if charDialogue[0]=3 {convo[0]+=1*gDeltaTime;if convo[0]>=135 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=4
    {
  ...
  else if global.gameProgress=2270 and room=rVault_4 //Time switch doors
  {
    ...
    else if charDialogue[0]=1 {convo[0]+=1*gDeltaTime;if convo[0]>=240 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=2
    {
  ...
  else if global.gameProgress=2390 and room=rVault_10 //Hex taunts 2
  {
    ...
    else if charDialogue[0]=1 {convo[0]+=1*gDeltaTime;if convo[0]>=75 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=2
    {
      msgCreate(0,0,"Claire","You've got issues.",0,0,oMessagePerson,0)
      newMessage.fadingTime=70; charDialogue[0]+=1
    }
    else if charDialogue[0]=3 {convo[0]+=1*gDeltaTime;if convo[0]>=75 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=4
    {
    ...
    else if charDialogue[0]=5 {convo[0]+=1*gDeltaTime;if convo[0]>=155 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=6
    {
      msgCreate(0,0,"Claire","But it does exist. It's the only world we have now, why fight it?",0,1,oMessagePerson,0)
      newMessage.fadingTime=100; charDialogue[0]+=1
    }
    else if charDialogue[0]=7 {convo[0]+=1*gDeltaTime;if convo[0]>=105 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=8
    {
      msgCreate(0,0,"Hex","The new girl thinks she can talk me down, how amusing.",0,2,oMessagePerson,0)
      newMessage.fadingTime=90; charDialogue[0]+=1
    }
    else if charDialogue[0]=9 {convo[0]+=1*gDeltaTime;if convo[0]>=95 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=10
    {
      msgCreate(0,0,"Claire","I wasn't trying to. I just don't get what you're trying to do.",0,2,oMessagePerson,0)
      newMessage.fadingTime=90; charDialogue[0]+=1
    }
    else if charDialogue[0]=11 {convo[0]+=1*gDeltaTime;if convo[0]>=95 {charDialogue[0]+=1; convo[0]=0}}
    else if charDialogue[0]=12
    {
      msgCreate(0,0,"Hex","That's not for you to know.",0,1,oMessagePerson,0)
      newMessage.fadingTime=70; charDialogue[0]+=1
    }
    else if charDialogue[0]=13 {convo[0]+=1*gDeltaTime;if convo[0]>=75 {charDialogue[0]+=1; convo[0]=0}}
  }
