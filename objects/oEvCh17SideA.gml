...
if global.gamePaused=false
{
  ...
  else if room=rHPF_C
  {
    if global.gameProgress<=3960 //A door blocks the way
    {
      ...
      else if charDialogue[0]=3 {convo[0]+=1*gDeltaTime;if convo[0]>=200 {charDialogue[0]+=1; convo[0]=0}}
      ...
      else if charDialogue[0]=7 {convo[0]+=1*gDeltaTime;if convo[0]>=130 {charDialogue[0]+=1; convo[0]=0}}
